    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <!-- End of Topbar -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        <div class="col-sm-12">
                            <a href="#" class='btn btn-primary mb-2' data-toggle='modal' data-target='#createStore'>
                              Create new Store
                            </a>
                            <div class="card">
...
@include('site.admin.stores.modal')
            </div>
            <!-- /.container-fluid -->
...
var user_id
            ...
            $(document).on('submit','#store_form_update',function(e){
                e.preventDefault();
